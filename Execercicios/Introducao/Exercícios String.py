...
"""
CPF_merlhorado = input("Insira seu CPF")

CPF_merlhorado = CPF_merlhorado.strip()
CPF_merlhorado = CPF_merlhorado.replace(".","")
CPF_merlhorado = CPF_merlhorado.replace("-","")

if len(CPF_merlhorado) == 11 and CPF_merlhorado.isnumeric():
    print("CPF OK!!")
else:
    print("Digite seu CPF corretamente e digite apenas números")

print(CPF_merlhorado)
...
if nome and email:
    ...
    dominio = email[posicao_arroba:]
    if posicao_arroba != -1 and "." in dominio:
