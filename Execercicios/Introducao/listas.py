...
novo_produto = input("Informe um novo produto").lower()
...
consulta = input("Informe nome do produto").lower()

try:
    produtos.index(consulta)
    print(f"O produto {produtos[produtos.index(consulta)]} custa R${precos[produtos.index(consulta)]}")
except:
...
qtd_vendas = float(input("Informe o valor de vendas: "))

if qtd_vendas <= 1000:
    print("Não ganhou bônus")
elif qtd_vendas <= 5000:
    print(f"Bônus de R${qtd_vendas*2:,.2f}")
else:
    print(f"Bônus de R${qtd_vendas*2+1000:,.2f}")
